...
I need a clear and maintainable project structure, and how to properly handle Exploratory Data Analysis without including it with the production code
...
- Replication (That's why I named it modelops-lab instead of wine-quality-bmlop)
